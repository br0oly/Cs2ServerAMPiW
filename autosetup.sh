...
echo ""
echo "Następne kroki:"
echo "  1. Zaloguj się na konto serwera:  su - ${SERVER_USER}"
echo "  2. Uruchom serwer:                screen -S cs2"
echo "     cd ${SERVER_ROOT}/game/bin/linuxsteamrt64"
echo "     ./cs2 -dedicated -console -usercon +sv_lan 1 +game_type 0 +game_mode 1 +map de_dust2 -port 27015 +exec server.cfg"
echo "  3. Odłącz konsolę (serwer działa): Ctrl+A, potem D"
echo "  4. Wróć do konsoli serwera:        screen -r cs2"
echo ""
echo "Otwarte porty:"
